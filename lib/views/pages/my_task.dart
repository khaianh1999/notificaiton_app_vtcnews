...
class _MyTaskState extends State<MyTask> with TickerProviderStateMixin {
  ...
  Future<void> _loadTasks() async {
    ...
    try {
      final url =
          'https://work.vtcnews.vn/Task/GetTasksByEmail?email=$_savedEmail&year=$_selectedYear&month=$_selectedMonth';
